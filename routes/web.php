...
use App\Http\Controllers\FinanceSettingsController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('settings/finance', [FinanceSettingsController::class, 'index'])->name('settings.finance');
    Route::post('settings/finance/currencies', [FinanceSettingsController::class, 'storeCurrency'])->name('settings.finance.currencies.store');
    Route::post('settings/finance/taxes', [FinanceSettingsController::class, 'storeTax'])->name('settings.finance.taxes.store');
    Route::post('settings/finance/payment-methods', [FinanceSettingsController::class, 'storePaymentMethod'])->name('settings.finance.payment-methods.store');
